import{f as o}from"./Button-BLpNJ5b7.js";import{M as s}from"./Header-DacV1ENf.js";import"./index-Bqoxw6Vv.js";import"./vue.esm-bundler-CiDmsWPk.js";const f={title:"Example/Header",component:s,tags:["autodocs"],render:p=>({components:{MyHeader:s},setup(){return{...p}},template:'<my-header :user="user" />'}),parameters:{layout:"fullscreen"},args:{onLogin:o(),onLogout:o(),onCreateAccount:o()}},e={args:{user:{name:"Jane Doe"}}},r={args:{user:null}};var a,n,t;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  args: {
    user: {
      name: 'Jane Doe'
    }
...
//# sourceMappingURL=Header.stories-fBb7WiQp.js.map
